  ...
  return (
    <>
      <button
        ...
        className="group -mx-1 inline-flex max-w-full cursor-pointer items-center gap-2 rounded-md px-1 text-left font-sans text-2xl font-bold tabular-nums text-gray-950 outline-none transition-colors hover:bg-gray-50 hover:text-gray-700 focus-visible:ring-3 focus-visible:ring-ring/50"
